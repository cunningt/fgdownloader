...
@CommandLine.Command
public class oopsyseparate {

    String steamerFile = "data/oopsyhitting.csv";

    String steamerPitchingFile = "data/oopsypitching.csv";
    ...
    public static void main (String...args) {
        oopsyseparate ss = new oopsyseparate();
        ss.separate();
    }
}
...
class SeparationService {
    ...
    public void readInFiles() throws IOException {
        ...
        boolean header = true;
        File minors = new File("oopsyminors.csv");
        if (minors.exists()) {
            minors.delete();
        }
   ...
   public void pitchingReadInFiles() throws IOException {
        ...
        boolean header = true;
        File minors = new File("oopsypitchingminors.csv");
        if (minors.exists()) {
            minors.delete();
        }
    ...
    public static void generateHtml(String csvPath, String htmlPath, String title) {
        try (
            ...
            html.append("        \"paging\": false,\n");
            html.append("        \"info\": false,\n");
            html.append("        \"lengthChange\": false,\n");
    ...
    public void writeAbbreviatedCSV() throws FileNotFoundException, IOException {
        ...
        for (String level : levels) {
            ...
            String csvFile = "oopsyabbreviated/" + level;
            String htmlFile = csvFile.replace(".csv", ".html");
        
            CSVPrinter printer = new CSVPrinter(new FileWriter(csvFile), CSVFormat.EXCEL);
            ...
            String title = level.replace(".csv", "").toUpperCase();

            generateHtml(csvFile, htmlFile, title );
        }
    }
